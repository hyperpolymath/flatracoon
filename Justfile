...
doctor:
    @echo "Running diagnostics for flatracoon..."
...
help-me:
    @echo "=== flatracoon Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/flatracoon/issues/new"
    @echo ""

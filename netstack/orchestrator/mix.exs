defmodule FlatracoonOrchestrator.MixProject do
  use Mix.Project

  def project do
    [
      app: :flatracoon_orchestrator,
      version: "0.1.0",
      elixir: "~> 1.15",
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind flatracoon_orchestrator", "esbuild flatracoon_orchestrator"],
      "assets.deploy": [
        "tailwind flatracoon_orchestrator --minify",
        "esbuild flatracoon_orchestrator --minify",
        "phx.digest"
      ],
